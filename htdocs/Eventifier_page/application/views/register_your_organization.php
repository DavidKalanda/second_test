  ...
  <div class="row">
    <div class="col-md-8">
      <section>
        ...
        <div class="container" style="margin-bottom: 50px">
          <div class="row">
              ...
              <div class="col-md-10"><h4 style="color: rgba(0,0,0,0.26);"><b>Step 1 of 3</b></h4>
                  ...
                  <input id="register_page" class="input" type="text" placeholder="Search your city" size="85">
              </div>
          </div>
        </div>
        ...
        <div class="container" style="margin-bottom: 50px">
          <div class="row">
              ...
              <div class="col-md-10"><h4 style="color: rgba(0,0,0,0.26);"><b>Step 2 of 3</b></h4>
                  ...
                  <input id="register_page" class="input" type="text" placeholder="Your organization name" size="85">
                  <h2><strong>Describe your organization</strong></h2>
                  <textarea rows="8" cols="85" type="text box" placeholder="My organization is for..."></textarea>
                  ...
                  <div class="form-group" id="private_organization">
                    <div class="col-md-4">
                        ...
                        <input type="radio" name="organization_type" style="margin-right: 5px" value="1" id="org_private" checked>Private</label>
                        <i class="glyphicon glyphicon-info-sign"></i>
                    </div>
                    <div class="col-md-4">
                        <label for="organization_type" style="font-size: 20px">
                        <input type="radio" name="organization_type" style="margin-right: 5px" id="org_public">Public</label>
                        <i class="glyphicon glyphicon-info-sign"></i>
                    </div>
                  </div>
                  ...
                  <div class="form-group" id="private_org_details">
                    ...
                    <div class="col-md-10 checkbox">
                      <label style="font-size: 20px; margin-left: 25px; margin-top: 20px">
                        ...
                        <input type="text" name="" placeholder="eg. 'user@institution.com'" size="75" style="margin-left: 45px; margin-top: 10px">
                    </div>
                  </div>
        ...
        <input type="submit" name="" value="Submit your organization" style="background-color: rgba(103,93,249,1); border-width: 0px; border-radius: 10px; box-shadow: 6px 6px 8px #888888">
        </div>
